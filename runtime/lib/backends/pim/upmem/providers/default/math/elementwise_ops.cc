...
common::Status Add<T>::RunImpl(const ExecutionContext &ctx) {
  ...
  kernel::runadd(env.GetDpuSet(), env.GetDpu(), env.GetNumDpus(), A, B, C, m,
                 n);
...
common::Status Subtract<T>::RunImpl(const ExecutionContext &ctx) {
  ...
  kernel::runsub(env.GetDpuSet(), env.GetDpu(), env.GetNumDpus(), A, B, C, m,
                 n);
...
common::Status Mul<T>::RunImpl(const ExecutionContext &ctx) {
  ...
  kernel::runmul(env.GetDpuSet(), env.GetDpu(), env.GetNumDpus(), A, B, C, m,
                 n);
...
common::Status Div<T>::RunImpl(const ExecutionContext &ctx) {
  ...
  kernel::rundiv(env.GetDpuSet(), env.GetDpu(), env.GetNumDpus(), A, B, C, m,
                 n);
