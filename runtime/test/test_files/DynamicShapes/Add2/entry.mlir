module attributes {byre.container_module} {
  func.func @main(%arg0: memref<?x?x3xf32, "cpu"> {byre.argname = "Input0", byre.argtype = 1 : i32},
    ...
    byre.compute @AddOp_f32f32_f32(%arg0, %arg1, %1) {device = "cpu", memory_effects = [1 : i32, 1 : i32, 2 : i32]} : memref<?x?x3xf32, "cpu">, memref<?x?x3xf32, "cpu">, memref<?x?x3xf32, "cpu">
    byre.compute @AddOp_f32f32_f32(%1, %1, %arg2) {device = "cpu", memory_effects = [1 : i32, 1 : i32, 2 : i32]} : memref<?x?x3xf32, "cpu">, memref<?x?x3xf32, "cpu">, memref<?x?x3xf32, "cpu">
    return
  }
}
