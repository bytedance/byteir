...
module attributes {byre.container_module} {
  func.func @test1(%arg0 : memref<100x32xf32, "cpu"> {byre.argname = "A", byre.argtype = 1: i32},
    ...
    byre.compute @AddOpf32f32f32(%arg0, %arg1, %arg2) : memref<100x32xf32, "cpu">, memref<100x32xf32, "cpu">, memref<100x32xf32, "cpu">
    byre.compute @AddOpf32f32f32(%arg1, %arg2, %arg3) : memref<100x32xf32, "cpu">, memref<100x32xf32, "cpu">, memref<100x32xf32, "cpu">
    return
  }
}
