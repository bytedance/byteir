module attributes {byre.container_module} {
  func.func @main(%arg0 : memref<4x!ace.string, "cpu"> {byre.argname = "Input", byre.argtype = 1: i32},
    ...
    byre.compute @tf.Equal(%arg0, %0, %arg1) {memory_effects = [1 : i32, 1 : i32, 2 : i32]} : memref<4x!ace.string, "cpu">, memref<4x!ace.string, "cpu">, memref<4xi1, "cpu">
    return
  }
}
