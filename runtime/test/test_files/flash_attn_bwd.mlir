module attributes {byre.container_module} {
  func.func @test_flash_attn_fwd_and_bwd(%arg0 : memref<1x128x3x32xf16, "cuda"> {byre.argname = "d_Out", byre.argtype = 2: i32},
    ...
    byre.compute @byteir.flash_attn_fwd(%arg1, %arg2, %arg3, %arg4, %arg5, %arg12, %arg9) {causal = true, dropout_p = 0.000000e+00 : f32, return_softmax = false, softmax_scale = 0.500000e+00 : f32} : memref<1x128x3x32xf16, "cuda">, memref<1x128x3x32xf16, "cuda">, memref<1x128x3x32xf16, "cuda">, memref<1x128x3x32xf16, "cuda">, memref<1x3x128xf32, "cuda">, memref<1x3x128x128xf32, "cuda">, memref<2xi64, "cuda">
