module attributes {byre.container_module, gpu.container_module} {
  func.func @forward(%arg0: memref<3x2xf32, "cuda"> {byre.argname = "Input0", byre.argtype = 1 : i32}, %arg1: memref<3x8xf32, "cuda"> {byre.argname = "Output0", byre.argtype = 2 : i32}) attributes {byre.entry_point, device_file_name = "ccl.ptx"} {
