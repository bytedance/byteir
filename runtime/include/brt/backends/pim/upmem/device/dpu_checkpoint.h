 ...
 * @hideinitializer
 */
#define DPU_CHECKPOINT_ALL (DPU_CHECKPOINT_INTERNAL | DPU_CHECKPOINT_IRAM | DPU_CHECKPOINT_MRAM | DPU_CHECKPOINT_WRAM)
 ...
 * @param serialized_context_size storage for the number of bytes of the DPU state content
 * @return Whether the operation was successful.
 */
dpu_error_t
 ...
 * @param serialized_context_size the number of bytes of the serialized DPU state
 * @param context storage for the DPU state
 * @return Whether the operation was successful.
 */
dpu_error_t
dpu_checkpoint_deserialize(const uint8_t *serialized_context, uint32_t serialized_context_size, struct dpu_context_t *context);
