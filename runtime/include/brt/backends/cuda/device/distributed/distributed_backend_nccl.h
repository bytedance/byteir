...
public:
  ...
  common::Status all_to_all(const void *sendbuff, void *recvbuff, size_t len,
                    DType dtype, std::shared_ptr<DContext> ctx) override;

  common::Status all_gather(const void *sendbuff, void *recvbuff, size_t sendlen,
                    DType dtype, std::shared_ptr<DContext> ctx) override;
  ...
  common::Status reduce_scatter(const void *sendbuff, void *recvbuff, size_t recvlen,
                        DType dtype, ReduceOp op,
                        std::shared_ptr<DContext> ctx) override;
  ...
  common::Status reduce(const void *sendbuff, void *recvbuff, size_t len, DType dtype,
