...
sed -i 's/your_file/resnet18_bw_device.ptx/g' ../../runtime/test/test_files/resnet18_bw_host_cuda.mlir
...
sed -i 's/your_file/resnet18_fw_device.ptx/g' ../../runtime/test/test_files/resnet18_fw_host_cuda.mlir
...
sed -i 's/your_file/resnet18_fw_bw_device.ptx/g' ../../runtime/test/test_files/resnet18_fw_bw_host_cuda.mlir
...
# sed -i 's/your_file/mlp_inference_device.ptx/g' ../../runtime/test/test_files/mlp_inference_host_cuda.mlir
