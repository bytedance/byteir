...
// RUN: FileCheck %s < %t
// RUN: python3 %S/numerical_test.py %s %t --decimal simplify_dot_general_bmm_case0:5,simplify_dot_general_bmm_case1:5,simplify_dot_mm_m1_case0:5,simplify_dot_mm_n1_case0:5
