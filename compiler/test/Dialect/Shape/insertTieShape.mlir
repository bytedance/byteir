...
// CHECK-NEXT:     %dim = tensor.dim %0, %c0 : tensor<?x4xf32>
// CHECK-NEXT:     "shape_ext.tie"(%0, %dim) : (tensor<?x4xf32>, index) -> ()
...
// CHECK-NEXT:     %dim_1 = tensor.dim %2, %c0_0 : tensor<?x4xf32>
// CHECK-NEXT:     "shape_ext.tie"(%2, %dim_1) : (tensor<?x4xf32>, index) -> ()
// CHECK-NEXT:     %3 = mhlo.add %0, %2 : tensor<?x4xf32>
// CHECK-NEXT:     %c0_2 = arith.constant 0 : index
// CHECK-NEXT:     %dim_3 = tensor.dim %3, %c0_2 : tensor<?x4xf32>
// CHECK-NEXT:     "shape_ext.tie"(%3, %dim_3) : (tensor<?x4xf32>, index) -> ()
