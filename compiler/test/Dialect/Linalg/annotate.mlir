...
^bb0(%arg1: !pdl.operation):
  ...
  %1, %loops:3 = transform.structured.tile_using_for %0 tile_sizes [128, 128, 32] interchange = [0, 1, 2] : (!pdl.operation) -> (!pdl.operation, !pdl.operation, !pdl.operation, !pdl.operation)
