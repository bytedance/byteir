// RUN: byteir-opt -convert-scf-to-cf -convert-arith-to-llvm -gpu-to-nvvm-ext='use-bare-ptr-memref-call-conv=1' -cse  %s | FileCheck %s
...
module attributes {gpu.container_module}  {
  ...
  // CHECK: llvm.func @fusion_broadcast_kernel(%arg0: !llvm.ptr {llvm.noalias}, %arg1: !llvm.ptr {llvm.noalias}, %arg2: !llvm.ptr {llvm.noalias}) attributes {gpu.kernel, nvvm.kernel}
