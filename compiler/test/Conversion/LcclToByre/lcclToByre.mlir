...
// CHECK:           byre.compute @nccl.Send(%[[VAL_0]]) {memory_effects = [1 : i32], rank = 0 : i64, synchronous = true} : memref<3xf32>
// CHECK:           return
// CHECK:         }
...
// CHECK:           byre.compute @nccl.Send(%[[VAL_0]], %[[VAL_1]]) {memory_effects = [1 : i32, 0 : i32], synchronous = true} : memref<3xf32>, i64
// CHECK:           return
// CHECK:         }
...
// CHECK-SAME:      %[[VAL_0:.*]]: memref<3xf32> {byre.argname = "in0", byre.argtype = 1 : i32}) attributes {byre.entry_point} {
// CHECK:           byre.compute @nccl.Recv(%[[VAL_0]]) {memory_effects = [2 : i32], rank = 0 : i64, synchronous = true} : memref<3xf32>
// CHECK:           return
// CHECK:         }
...
// CHECK-SAME:      %[[VAL_0:.*]]: memref<3xf32> {byre.argname = "in0", byre.argtype = 1 : i32},
// CHECK-SAME:      %[[VAL_1:.*]]: i64 {byre.argname = "in1", byre.argtype = 1 : i32}) attributes {byre.entry_point} {
// CHECK:           byre.compute @nccl.Recv(%[[VAL_0]], %[[VAL_1]]) {memory_effects = [2 : i32, 0 : i32], synchronous = true} : memref<3xf32>, i64
// CHECK:           return
// CHECK:         }
...
// CHECK:           byre.compute @nccl.AllReduce(%[[VAL_0]], %[[VAL_1]]) {memory_effects = [1 : i32, 2 : i32], reduction = "sum", replica_group = [0, 1], synchronous = true} : memref<3xf32>, memref<3xf32>
// CHECK:           byre.compute @nccl.AllReduce(%[[VAL_0]], %[[VAL_1]]) {memory_effects = [1 : i32, 2 : i32], reduction = "sum", replica_group = [2, 3], synchronous = true} : memref<3xf32>, memref<3xf32>
// CHECK:           return
// CHECK:         }
...
// CHECK:           byre.compute @nccl.AllReduce(%[[VAL_0]], %[[VAL_1]], %[[VAL_2]]) {memory_effects = [1 : i32, 2 : i32, 1 : i32], reduction = "sum", synchronous = true} : memref<3xf32>, memref<3xf32>, memref<2x2xindex>
// CHECK:           return
// CHECK:         }
...
// CHECK:           byre.compute @nccl.AllGather(%[[VAL_0]], %[[VAL_1]]) {axis = 0 : i64, memory_effects = [1 : i32, 2 : i32], replica_group = [0, 1], synchronous = true} : memref<4x4xf32>, memref<8x4xf32>
// CHECK:           byre.compute @nccl.AllGather(%[[VAL_0]], %[[VAL_1]]) {axis = 0 : i64, memory_effects = [1 : i32, 2 : i32], replica_group = [2, 3], synchronous = true} : memref<4x4xf32>, memref<8x4xf32>
// CHECK:           return
// CHECK:         }
...
// CHECK:           byre.compute @nccl.AllGather(%[[VAL_0]], %[[VAL_1]], %[[VAL_2]]) {axis = 0 : i64, memory_effects = [1 : i32, 2 : i32, 1 : i32], synchronous = true} : memref<4x4xf32>, memref<8x4xf32>, memref<2x2xindex>
// CHECK:           return
// CHECK:         }
