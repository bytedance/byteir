// RUN: byteir-opt -gen-ptx-config --inline -gpu-launch-func-to-byre --allow-unregistered-dialect %s | FileCheck %s
...
module attributes {gpu.container_module}  {
  ...
  // CHECK-SAME: {BlockSize.x = 32 : i32, BlockSize.y = 1 : i32, BlockSize.z = 1 : i32, GridSize.x = 4 : i32, GridSize.y = 1 : i32, GridSize.z = 1 : i32, device_file_name = "unified", kernel_name = "Unknown0_kernel"}
}
