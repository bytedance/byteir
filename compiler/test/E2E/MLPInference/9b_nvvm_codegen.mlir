...
module attributes {byre.container_module, gpu.container_module, torch.debug_module_name = "GraphModule"} {
  ...
  func.func @forward(%arg0: memref<2x10xf32, "cuda"> {byre.argname = "Input0", byre.argtype = 1 : i32}, %arg1: memref<2x10xf32, "cuda"> {byre.argname = "Output0", byre.argtype = 2 : i32}) attributes {byre.entry_point} {
    ...
    byre.compute @MatmulOp_f32f32_f32(%arg0, %alloc_6, %0) {device = "cuda", lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 0 : i64} : memref<2x10xf32, "cuda">, memref<10x20xf32, "cuda">, memref<2x20xf32, "cuda">
    ...
    byre.compute @MatmulOp_f32f32_f32(%1, %alloc_5, %0) {device = "cuda", lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 0 : i64} : memref<2x20xf32, "cuda">, memref<20x20xf32, "cuda">, memref<2x20xf32, "cuda">
    ...
    byre.compute @MatmulOp_f32f32_f32(%1, %alloc_4, %2) {device = "cuda", lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 0 : i64} : memref<2x20xf32, "cuda">, memref<20x10xf32, "cuda">, memref<2x10xf32, "cuda">
