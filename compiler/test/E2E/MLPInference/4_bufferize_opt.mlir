...
module attributes {torch.debug_module_name = "GraphModule"} {
  ...
  func.func @forward(%arg0: tensor<2x10xf32>) -> tensor<2x10xf32> attributes {__placeholder__byre.entry_point} {
    ...
    %0 = byre.compute @MatmulOp_f32f32_f32(%arg0, %cst_4) {lhs_contracting_dimension = 1 : i64, rhs_contracting_dimension = 0 : i64} : tensor<2x10xf32>, tensor<10x20xf32> -> tensor<2x20xf32>
    %1 = call @Unknown0(%cst, %0) : (tensor<20xf32>, tensor<2x20xf32>) -> tensor<2x20xf32>
    %2 = byre.compute @MatmulOp_f32f32_f32(%1, %cst_3) {lhs_contracting_dimension = 1 : i64, rhs_contracting_dimension = 0 : i64} : tensor<2x20xf32>, tensor<20x20xf32> -> tensor<2x20xf32>
    %3 = call @Unknown1(%cst_0, %2) : (tensor<20xf32>, tensor<2x20xf32>) -> tensor<2x20xf32>
    %4 = byre.compute @MatmulOp_f32f32_f32(%3, %cst_2) {lhs_contracting_dimension = 1 : i64, rhs_contracting_dimension = 0 : i64} : tensor<2x20xf32>, tensor<20x10xf32> -> tensor<2x10xf32>
    %5 = call @Unknown2(%cst_1, %4) : (tensor<10xf32>, tensor<2x10xf32>) -> tensor<2x10xf32>
    return %5 : tensor<2x10xf32>
  }
}