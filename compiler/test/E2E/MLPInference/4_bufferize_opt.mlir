...
module attributes {torch.debug_module_name = "GraphModule"} {
  ...
  func.func @forward(%arg0: tensor<2x10xf32>) -> tensor<2x10xf32> attributes {__placeholder__byre.entry_point} {
    ...
    %0 = tensor.empty() : tensor<2x20xf32>
    %1 = byre.compute_on_tensor @MatmulOp_f32f32_f32 {lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 0 : i64} ins(%arg0, %cst_4 : tensor<2x10xf32>, tensor<10x20xf32>) outs(%0 : tensor<2x20xf32>) : tensor<2x20xf32>
    %2 = call @Unknown0(%cst, %1) : (tensor<20xf32>, tensor<2x20xf32>) -> tensor<2x20xf32>
    %3 = tensor.empty() : tensor<2x20xf32>
    %4 = byre.compute_on_tensor @MatmulOp_f32f32_f32 {lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 0 : i64} ins(%2, %cst_3 : tensor<2x20xf32>, tensor<20x20xf32>) outs(%3 : tensor<2x20xf32>) : tensor<2x20xf32>
    %5 = call @Unknown1(%cst_0, %4) : (tensor<20xf32>, tensor<2x20xf32>) -> tensor<2x20xf32>
    %6 = tensor.empty() : tensor<2x10xf32>
    %7 = byre.compute_on_tensor @MatmulOp_f32f32_f32 {lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 0 : i64} ins(%5, %cst_2 : tensor<2x20xf32>, tensor<20x10xf32>) outs(%6 : tensor<2x10xf32>) : tensor<2x10xf32>
