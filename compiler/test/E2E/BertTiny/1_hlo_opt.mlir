...
module {
  func.func @main(%arg0: tensor<2x128xi64>, %arg1: tensor<2x128xi64>, %arg2: tensor<1x512xi64>, %arg3: tensor<1x512xi64>, %arg4: tensor<30522x128xf32>, %arg5: tensor<2x128xf32>, %arg6: tensor<512x128xf32>, %arg7: tensor<128xf32>, %arg8: tensor<128xf32>, %arg9: tensor<128x128xf32>, %arg10: tensor<128xf32>, %arg11: tensor<128x128xf32>, %arg12: tensor<128xf32>, %arg13: tensor<128x128xf32>, %arg14: tensor<128xf32>, %arg15: tensor<128x128xf32>, %arg16: tensor<128xf32>, %arg17: tensor<128xf32>, %arg18: tensor<128xf32>, %arg19: tensor<512x128xf32>, %arg20: tensor<512xf32>, %arg21: tensor<128x512xf32>, %arg22: tensor<128xf32>, %arg23: tensor<128xf32>, %arg24: tensor<128xf32>, %arg25: tensor<128x128xf32>, %arg26: tensor<128xf32>, %arg27: tensor<128x128xf32>, %arg28: tensor<128xf32>, %arg29: tensor<128x128xf32>, %arg30: tensor<128xf32>, %arg31: tensor<128x128xf32>, %arg32: tensor<128xf32>, %arg33: tensor<128xf32>, %arg34: tensor<128xf32>, %arg35: tensor<512x128xf32>, %arg36: tensor<512xf32>, %arg37: tensor<128x512xf32>, %arg38: tensor<128xf32>, %arg39: tensor<128xf32>, %arg40: tensor<128xf32>, %arg41: tensor<128x128xf32>, %arg42: tensor<128xf32>, %arg43: tensor<128xf32>, %arg44: tensor<128xf32>, %arg45: tensor<30522xf32>) -> !tuple {
    ...
    %22 = mhlo.custom_call @ftv4.layernorm(%21, %arg7, %arg8) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>
    %23 = mhlo.get_tuple_element %22[0] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>) -> tensor<2x128x128xf32>
    %24 = mhlo.custom_call @ftv4.linear_transpose(%23, %arg9, %arg10) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x2x128x64xf32>
    %25 = mhlo.custom_call @ftv4.linear_transpose(%23, %arg11, %arg12) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x2x128x64xf32>
    %26 = mhlo.custom_call @ftv4.matmul(%24, %25) {backend_config = "{scale = 1.250000e-01 : f32, transpose_a = false, transpose_b = true}"} : (tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>) -> tensor<2x2x128x128xf32>
    ...
    %46 = mhlo.custom_call @ftv4.softmax(%26, %45) {backend_config = "{batch_first = true, dropout_rate = 0.000000e+00 : f32, head_num = 2 : i32}"} : (tensor<2x2x128x128xf32>, tensor<2x128x128xf32>) -> tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>
    %47 = mhlo.get_tuple_element %46[1] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>) -> tensor<2x2x128x128xf32>
    %48 = mhlo.get_tuple_element %46[0] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>) -> tensor<2x2x128x128xf32>
    %49 = mhlo.custom_call @ftv4.linear_transpose(%23, %arg13, %arg14) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x2x128x64xf32>
    %50 = mhlo.custom_call @ftv4.matmul(%48, %49) {backend_config = "{scale = 1.000000e+00 : f32, transpose_a = false, transpose_b = false}"} : (tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>) -> tensor<2x2x128x64xf32>
    %51 = mhlo.custom_call @ftv4.transpose4d(%50) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22}"} : (tensor<2x2x128x64xf32>) -> tensor<2x128x2x64xf32>
    %52 = call @aten.view.223(%51) : (tensor<2x128x2x64xf32>) -> tensor<2x128x128xf32>
    %53 = mhlo.custom_call @ftv4.linear(%52, %arg15, %arg16) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x128x128xf32>
    %54 = mhlo.custom_call @ftv4.layernorm_residual(%53, %arg17, %arg18, %23) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>
    %55 = mhlo.get_tuple_element %54[0] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %56 = mhlo.custom_call @ftv4.linear_gelu_dropout(%55, %arg19, %arg20) {backend_config = "{act_gelu = true, dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>) -> tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>
    %57 = mhlo.get_tuple_element %56[0] : (tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>) -> tensor<2x128x512xf32>
    %58 = mhlo.custom_call @ftv4.linear(%57, %arg21, %arg22) {backend_config = ""} : (tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>) -> tensor<2x128x128xf32>
    %59 = mhlo.custom_call @ftv4.layernorm_residual(%58, %arg23, %arg24, %55) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>
    %60 = mhlo.get_tuple_element %59[0] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %61 = mhlo.custom_call @ftv4.linear_transpose(%60, %arg25, %arg26) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x2x128x64xf32>
    %62 = mhlo.custom_call @ftv4.linear_transpose(%60, %arg27, %arg28) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x2x128x64xf32>
    %63 = mhlo.custom_call @ftv4.matmul(%61, %62) {backend_config = "{scale = 1.250000e-01 : f32, transpose_a = false, transpose_b = true}"} : (tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>) -> tensor<2x2x128x128xf32>
    ...
    %69 = mhlo.custom_call @ftv4.softmax(%63, %68) {backend_config = "{batch_first = true, dropout_rate = 0.000000e+00 : f32, head_num = 2 : i32}"} : (tensor<2x2x128x128xf32>, tensor<2x128x128xf32>) -> tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>
    %70 = mhlo.get_tuple_element %69[1] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>) -> tensor<2x2x128x128xf32>
    %71 = mhlo.get_tuple_element %69[0] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>) -> tensor<2x2x128x128xf32>
    %72 = mhlo.custom_call @ftv4.linear_transpose(%60, %arg29, %arg30) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x2x128x64xf32>
    %73 = mhlo.custom_call @ftv4.matmul(%71, %72) {backend_config = "{scale = 1.000000e+00 : f32, transpose_a = false, transpose_b = false}"} : (tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>) -> tensor<2x2x128x64xf32>
    %74 = mhlo.custom_call @ftv4.transpose4d(%73) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22}"} : (tensor<2x2x128x64xf32>) -> tensor<2x128x2x64xf32>
    %75 = call @aten.view.223(%74) : (tensor<2x128x2x64xf32>) -> tensor<2x128x128xf32>
    %76 = mhlo.custom_call @ftv4.linear(%75, %arg31, %arg32) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tensor<2x128x128xf32>
    %77 = mhlo.custom_call @ftv4.layernorm_residual(%76, %arg33, %arg34, %60) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>
    %78 = mhlo.get_tuple_element %77[0] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %79 = mhlo.custom_call @ftv4.linear_gelu_dropout(%78, %arg35, %arg36) {backend_config = "{act_gelu = true, dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>) -> tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>
    %80 = mhlo.get_tuple_element %79[0] : (tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>) -> tensor<2x128x512xf32>
    %81 = mhlo.custom_call @ftv4.linear(%80, %arg37, %arg38) {backend_config = ""} : (tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>) -> tensor<2x128x128xf32>
    %82 = mhlo.custom_call @ftv4.layernorm_residual(%81, %arg39, %arg40, %78) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>
    %83 = mhlo.get_tuple_element %82[0] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %84 = mhlo.custom_call @ftv4.linear_gelu_dropout(%83, %arg41, %arg42) {backend_config = "{act_gelu = true, dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<0xf32>>
    %85 = mhlo.get_tuple_element %84[0] : (tuple<tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<0xf32>>) -> tensor<2x128x128xf32>
    %86 = mhlo.custom_call @ftv4.layernorm(%85, %arg43, %arg44) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>
    %87 = mhlo.get_tuple_element %86[0] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>) -> tensor<2x128x128xf32>
    ...
    %130 = mhlo.get_tuple_element %86[1] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>) -> tensor<256xf32>
    %131 = mhlo.get_tuple_element %86[2] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>) -> tensor<256xf32>
    %132 = mhlo.custom_call @ftv4.layernorm_backward(%129, %85, %arg43, %130, %131) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128xf32>, tensor<256xf32>, tensor<256xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>
    %133 = mhlo.get_tuple_element %132[0] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    %134 = mhlo.get_tuple_element %84[1] : (tuple<tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<0xf32>>) -> tensor<2x128x128xf32>
    %135 = mhlo.get_tuple_element %84[2] : (tuple<tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<0xf32>>) -> tensor<0xf32>
    %136 = mhlo.custom_call @ftv4.linear_gelu_dropout_backward(%133, %83, %arg41, %134, %135) {backend_config = "{act_gelu = true, dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<2x128x128xf32>, tensor<0xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %137 = mhlo.get_tuple_element %136[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    %138 = mhlo.get_tuple_element %82[3] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %139 = mhlo.get_tuple_element %82[1] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %140 = mhlo.get_tuple_element %82[2] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %141 = mhlo.custom_call @ftv4.layernorm_backward_residual(%137, %138, %arg39, %139, %140) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128xf32>, tensor<256xf32>, tensor<256xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>
    %142 = mhlo.get_tuple_element %141[3] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %143 = mhlo.get_tuple_element %141[0] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %144 = mhlo.custom_call @ftv4.linear_backward(%143, %80, %arg37) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x512xf32>, tensor<128x512xf32>) -> tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>
    %145 = mhlo.get_tuple_element %144[0] : (tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>) -> tensor<2x128x512xf32>
    %146 = mhlo.get_tuple_element %79[1] : (tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>) -> tensor<2x128x512xf32>
    %147 = mhlo.get_tuple_element %79[2] : (tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>) -> tensor<0xf32>
    %148 = mhlo.custom_call @ftv4.linear_gelu_dropout_backward(%145, %78, %arg35, %146, %147) {backend_config = "{act_gelu = true, dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x128x512xf32>, tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<2x128x512xf32>, tensor<0xf32>) -> tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>
    %149 = mhlo.get_tuple_element %148[0] : (tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>) -> tensor<2x128x128xf32>
    ...
    %154 = mhlo.get_tuple_element %77[3] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %155 = mhlo.get_tuple_element %77[1] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %156 = mhlo.get_tuple_element %77[2] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %157 = mhlo.custom_call @ftv4.layernorm_backward_residual(%153, %154, %arg33, %155, %156) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128xf32>, tensor<256xf32>, tensor<256xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>
    %158 = mhlo.get_tuple_element %157[3] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %159 = mhlo.get_tuple_element %157[0] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %160 = mhlo.custom_call @ftv4.linear_backward(%159, %75, %arg31) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %161 = mhlo.get_tuple_element %160[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    %162 = call @aten.view.494(%161) : (tensor<2x128x128xf32>) -> tensor<2x128x2x64xf32>
    %163 = mhlo.custom_call @ftv4.transpose4d_backward(%162) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22}"} : (tensor<2x128x2x64xf32>) -> tensor<2x2x128x64xf32>
    %164 = mhlo.custom_call @ftv4.matmul_backward(%163, %71, %72) {backend_config = "{scale = 1.000000e+00 : f32, transpose_a = false, transpose_b = false}"} : (tensor<2x2x128x64xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>) -> tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>>
    %165 = mhlo.get_tuple_element %164[0] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x128xf32>
    %166 = mhlo.get_tuple_element %69[2] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>) -> tensor<2x2x128x128xui8>
    %167 = mhlo.custom_call @ftv4.softmax_backward(%165, %71, %166) {backend_config = "{dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>) -> tensor<2x2x128x128xf32>
    %168 = mhlo.custom_call @ftv4.matmul_backward(%167, %61, %62) {backend_config = "{scale = 1.250000e-01 : f32, transpose_a = false, transpose_b = true}"} : (tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>) -> tuple<tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>>
    %169 = mhlo.get_tuple_element %168[0] : (tuple<tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x64xf32>
    %170 = mhlo.custom_call @ftv4.linear_transpose_backward(%169, %60, %arg25) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x2x128x64xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %171 = mhlo.get_tuple_element %170[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    ...
    %176 = mhlo.get_tuple_element %164[1] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x64xf32>
    %177 = mhlo.custom_call @ftv4.linear_transpose_backward(%176, %60, %arg29) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x2x128x64xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %178 = mhlo.get_tuple_element %177[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    ...
    %183 = mhlo.get_tuple_element %168[1] : (tuple<tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x64xf32>
    %184 = mhlo.custom_call @ftv4.linear_transpose_backward(%183, %60, %arg27) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x2x128x64xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %185 = mhlo.get_tuple_element %184[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    ...
    %190 = mhlo.get_tuple_element %59[3] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %191 = mhlo.get_tuple_element %59[1] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %192 = mhlo.get_tuple_element %59[2] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %193 = mhlo.custom_call @ftv4.layernorm_backward_residual(%189, %190, %arg23, %191, %192) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128xf32>, tensor<256xf32>, tensor<256xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>
    %194 = mhlo.get_tuple_element %193[3] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %195 = mhlo.get_tuple_element %193[0] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %196 = mhlo.custom_call @ftv4.linear_backward(%195, %57, %arg21) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x512xf32>, tensor<128x512xf32>) -> tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>
    %197 = mhlo.get_tuple_element %196[0] : (tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>) -> tensor<2x128x512xf32>
    %198 = mhlo.get_tuple_element %56[1] : (tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>) -> tensor<2x128x512xf32>
    %199 = mhlo.get_tuple_element %56[2] : (tuple<tensor<2x128x512xf32>, tensor<2x128x512xf32>, tensor<0xf32>>) -> tensor<0xf32>
    %200 = mhlo.custom_call @ftv4.linear_gelu_dropout_backward(%197, %55, %arg19, %198, %199) {backend_config = "{act_gelu = true, dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x128x512xf32>, tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<2x128x512xf32>, tensor<0xf32>) -> tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>
    %201 = mhlo.get_tuple_element %200[0] : (tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>) -> tensor<2x128x128xf32>
    ...
    %206 = mhlo.get_tuple_element %54[3] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %207 = mhlo.get_tuple_element %54[1] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %208 = mhlo.get_tuple_element %54[2] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>, tensor<2x128x128xf32>>) -> tensor<256xf32>
    %209 = mhlo.custom_call @ftv4.layernorm_backward_residual(%205, %206, %arg17, %207, %208) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128xf32>, tensor<256xf32>, tensor<256xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>
    %210 = mhlo.get_tuple_element %209[3] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %211 = mhlo.get_tuple_element %209[0] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<2x128x128xf32>
    %212 = mhlo.custom_call @ftv4.linear_backward(%211, %52, %arg15) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %213 = mhlo.get_tuple_element %212[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    %214 = call @aten.view.494(%213) : (tensor<2x128x128xf32>) -> tensor<2x128x2x64xf32>
    %215 = mhlo.custom_call @ftv4.transpose4d_backward(%214) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22}"} : (tensor<2x128x2x64xf32>) -> tensor<2x2x128x64xf32>
    %216 = mhlo.custom_call @ftv4.matmul_backward(%215, %48, %49) {backend_config = "{scale = 1.000000e+00 : f32, transpose_a = false, transpose_b = false}"} : (tensor<2x2x128x64xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>) -> tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>>
    %217 = mhlo.get_tuple_element %216[0] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x128xf32>
    %218 = mhlo.get_tuple_element %46[2] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>>) -> tensor<2x2x128x128xui8>
    %219 = mhlo.custom_call @ftv4.softmax_backward(%217, %48, %218) {backend_config = "{dropout_rate = 0.000000e+00 : f32}"} : (tensor<2x2x128x128xf32>, tensor<2x2x128x128xf32>, tensor<2x2x128x128xui8>) -> tensor<2x2x128x128xf32>
    %220 = mhlo.custom_call @ftv4.matmul_backward(%219, %24, %25) {backend_config = "{scale = 1.250000e-01 : f32, transpose_a = false, transpose_b = true}"} : (tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>) -> tuple<tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>>
    %221 = mhlo.get_tuple_element %220[0] : (tuple<tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x64xf32>
    %222 = mhlo.custom_call @ftv4.linear_transpose_backward(%221, %23, %arg9) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x2x128x64xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %223 = mhlo.get_tuple_element %222[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    ...
    %228 = mhlo.get_tuple_element %216[1] : (tuple<tensor<2x2x128x128xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x64xf32>
    %229 = mhlo.custom_call @ftv4.linear_transpose_backward(%228, %23, %arg13) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x2x128x64xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %230 = mhlo.get_tuple_element %229[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    ...
    %235 = mhlo.get_tuple_element %220[1] : (tuple<tensor<2x2x128x64xf32>, tensor<2x2x128x64xf32>>) -> tensor<2x2x128x64xf32>
    %236 = mhlo.custom_call @ftv4.linear_transpose_backward(%235, %23, %arg11) {backend_config = "{forward_transpose_type = \22TRANSPOSE0213\22, head_num = 2 : i32}"} : (tensor<2x2x128x64xf32>, tensor<2x128x128xf32>, tensor<128x128xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>
    %237 = mhlo.get_tuple_element %236[0] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    ...
    %242 = mhlo.get_tuple_element %22[1] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>) -> tensor<256xf32>
    %243 = mhlo.get_tuple_element %22[2] : (tuple<tensor<2x128x128xf32>, tensor<256xf32>, tensor<256xf32>>) -> tensor<256xf32>
    %244 = mhlo.custom_call @ftv4.layernorm_backward(%241, %21, %arg7, %242, %243) {backend_config = ""} : (tensor<2x128x128xf32>, tensor<2x128x128xf32>, tensor<128xf32>, tensor<256xf32>, tensor<256xf32>) -> tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>
    %245 = mhlo.get_tuple_element %244[0] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>) -> tensor<2x128x128xf32>
    ...
    %299 = mhlo.get_tuple_element %244[1] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %300 = mhlo.get_tuple_element %244[2] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %301 = mhlo.get_tuple_element %222[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %302 = mhlo.get_tuple_element %222[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %303 = mhlo.get_tuple_element %236[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %304 = mhlo.get_tuple_element %236[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %305 = mhlo.get_tuple_element %229[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %306 = mhlo.get_tuple_element %229[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %307 = mhlo.get_tuple_element %212[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %308 = mhlo.get_tuple_element %212[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %309 = mhlo.get_tuple_element %209[1] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %310 = mhlo.get_tuple_element %209[2] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %311 = mhlo.get_tuple_element %200[1] : (tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>) -> tensor<512x128xf32>
    %312 = mhlo.get_tuple_element %200[2] : (tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>) -> tensor<512xf32>
    %313 = mhlo.get_tuple_element %196[1] : (tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>) -> tensor<128x512xf32>
    %314 = mhlo.get_tuple_element %196[2] : (tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %315 = mhlo.get_tuple_element %193[1] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %316 = mhlo.get_tuple_element %193[2] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %317 = mhlo.get_tuple_element %170[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %318 = mhlo.get_tuple_element %170[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %319 = mhlo.get_tuple_element %184[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %320 = mhlo.get_tuple_element %184[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %321 = mhlo.get_tuple_element %177[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %322 = mhlo.get_tuple_element %177[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %323 = mhlo.get_tuple_element %160[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %324 = mhlo.get_tuple_element %160[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %325 = mhlo.get_tuple_element %157[1] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %326 = mhlo.get_tuple_element %157[2] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %327 = mhlo.get_tuple_element %148[1] : (tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>) -> tensor<512x128xf32>
    %328 = mhlo.get_tuple_element %148[2] : (tuple<tensor<2x128x128xf32>, tensor<512x128xf32>, tensor<512xf32>>) -> tensor<512xf32>
    %329 = mhlo.get_tuple_element %144[1] : (tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>) -> tensor<128x512xf32>
    %330 = mhlo.get_tuple_element %144[2] : (tuple<tensor<2x128x512xf32>, tensor<128x512xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %331 = mhlo.get_tuple_element %141[1] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %332 = mhlo.get_tuple_element %141[2] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>, tensor<2x128x128xf32>>) -> tensor<128xf32>
    %333 = mhlo.get_tuple_element %136[1] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128x128xf32>
    %334 = mhlo.get_tuple_element %136[2] : (tuple<tensor<2x128x128xf32>, tensor<128x128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %335 = mhlo.get_tuple_element %132[1] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    %336 = mhlo.get_tuple_element %132[2] : (tuple<tensor<2x128x128xf32>, tensor<128xf32>, tensor<128xf32>>) -> tensor<128xf32>
    ...
    %340 = mhlo.tuple %97, %102, %255, %275, %298, %299, %300, %301, %302, %303, %304, %305, %306, %307, %308, %309, %310, %311, %312, %313, %314, %315, %316, %317, %318, %319, %320, %321, %322, %323, %324, %325, %326, %327, %328, %329, %330, %331, %332, %333, %334, %335, %336, %339 : !tuple
    return %340 : !tuple
  }
  ...
  func.func private @aten.log_softmax.318(%arg0: tensor<256x30522xf32>) -> tensor<256x30522xf32> {
    ...
    %1 = mhlo.reduce(%arg0 init: %0) across dimensions = [1] : (tensor<256x30522xf32>, tensor<f32>) -> tensor<256xf32>
    ...
    %4 = mhlo.exponential %3 : tensor<256x30522xf32>
    %5 = mhlo.constant dense<0.000000e+00> : tensor<f32>
    %6 = mhlo.reduce(%4 init: %5) across dimensions = [1] : (tensor<256x30522xf32>, tensor<f32>) -> tensor<256xf32>
     reducer(%arg1: tensor<f32>, %arg2: tensor<f32>)  {
      %10 = mhlo.add %arg1, %arg2 : tensor<f32>
      mhlo.return %10 : tensor<f32>
    }
    %7 = mhlo.log %6 : tensor<256xf32>
  ...
  func.func private @aten.nll_loss.335(%arg0: tensor<256x30522xf32>, %arg1: tensor<256xi64>) -> tensor<f32> {
    ...
    %4 = mhlo.compare  EQ, %0, %3 : (tensor<256x30522xi64>, tensor<256x30522xi64>) -> tensor<256x30522xi1>
    ...
    %9 = mhlo.select %4, %6, %8 : tensor<256x30522xi1>, tensor<256x30522xf32>
    %10 = "mhlo.broadcast_in_dim"(%5) {broadcast_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>) -> tensor<256x30522xf32>
    %11 = mhlo.compare  NE, %9, %10 : (tensor<256x30522xf32>, tensor<256x30522xf32>) -> tensor<256x30522xi1>
    %12 = "mhlo.broadcast_in_dim"(%7) {broadcast_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>) -> tensor<256x30522xf32>
    %13 = mhlo.negate %9 : tensor<256x30522xf32>
    %14 = mhlo.multiply %13, %arg0 : tensor<256x30522xf32>
    %15 = mhlo.select %11, %12, %14 : tensor<256x30522xi1>, tensor<256x30522xf32>
    ...
    %18 = mhlo.compare  NE, %arg1, %17 : (tensor<256xi64>, tensor<256xi64>) -> tensor<256xi1>
    ...
    %24 = mhlo.select %19, %21, %23 : tensor<256x30522xi1>, tensor<256x30522xf32>
    %25 = mhlo.multiply %24, %9 : tensor<256x30522xf32>
    %26 = mhlo.multiply %15, %25 : tensor<256x30522xf32>
    %27 = mhlo.reduce(%26 init: %7) across dimensions = [0, 1] : (tensor<256x30522xf32>, tensor<f32>) -> tensor<f32>
    ...
    %29 = mhlo.reduce(%25 init: %28) across dimensions = [0, 1] : (tensor<256x30522xf32>, tensor<f32>) -> tensor<f32>
     reducer(%arg2: tensor<f32>, %arg3: tensor<f32>)  {
      %31 = mhlo.add %arg2, %arg3 : tensor<f32>
      mhlo.return %31 : tensor<f32>
    }
  ...
  func.func private @aten.nll_loss_backward.404(%arg0: tensor<f32>, %arg1: tensor<256x30522xf32>, %arg2: tensor<256xi64>) -> tensor<256x30522xf32> {
    ...
    %8 = "mhlo.broadcast_in_dim"(%7) {broadcast_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>) -> tensor<256x30522xf32>
    %9 = mhlo.select %4, %6, %8 : tensor<256x30522xi1>, tensor<256x30522xf32>
    %10 = mhlo.negate %9 : tensor<256x30522xf32>
    ...
    %15 = mhlo.compare  NE, %arg2, %14 : (tensor<256xi64>, tensor<256xi64>) -> tensor<256xi1>
    ...
    %21 = mhlo.select %16, %18, %20 : tensor<256x30522xi1>, tensor<256x30522xf32>
    ...
    %25 = mhlo.reduce(%22 init: %24) across dimensions = [0, 1] : (tensor<256x30522xf32>, tensor<f32>) -> tensor<f32>
     reducer(%arg3: tensor<f32>, %arg4: tensor<f32>)  {
      %31 = mhlo.add %arg3, %arg4 : tensor<f32>
      mhlo.return %31 : tensor<f32>
    }
    %26 = mhlo.compare  NE, %25, %24 : (tensor<f32>, tensor<f32>) -> tensor<i1>
    %27 = mhlo.constant dense<1.000000e+00> : tensor<f32>
    %28 = mhlo.select %26, %25, %27 : tensor<i1>, tensor<f32>
  ...
  func.func private @aten._log_softmax_backward_data.444(%arg0: tensor<256x30522xf32>, %arg1: tensor<256x30522xf32>) -> tensor<256x30522xf32> {
    %0 = mhlo.exponential %arg1 : tensor<256x30522xf32>
    %1 = mhlo.constant dense<0.000000e+00> : tensor<f32>
    %2 = mhlo.reduce(%arg0 init: %1) across dimensions = [1] : (tensor<256x30522xf32>, tensor<f32>) -> tensor<256xf32>
     reducer(%arg2: tensor<f32>, %arg3: tensor<f32>)  {
  ...
  func.func private @aten.lt.627(%arg0: tensor<256xi64>, %arg1: tensor<i64>) -> tensor<256xi1> {
    ...
    %1 = mhlo.compare  LT, %arg0, %0 : (tensor<256xi64>, tensor<256xi64>) -> tensor<256xi1>
  ...
  func.func private @aten.where.633(%arg0: tensor<256xi1>, %arg1: tensor<256xi64>, %arg2: tensor<256xi64>) -> tensor<256xi64> {
    %0 = mhlo.select %arg0, %arg1, %arg2 : tensor<256xi1>, tensor<256xi64>
    return %0 : tensor<256xi64>
  }
  ...
  func.func private @aten.ne.590(%arg0: tensor<256xi64>, %arg1: tensor<f64>) -> tensor<256xi1> {
    ...
    %2 = mhlo.compare  NE, %0, %1 : (tensor<256xf64>, tensor<256xf64>) -> tensor<256xi1>
  ...
  func.func private @aten.where.607(%arg0: tensor<256x128xi1>, %arg1: tensor<256x128xf32>, %arg2: tensor<256x128xf32>) -> tensor<256x128xf32> {
    %0 = mhlo.select %arg0, %arg1, %arg2 : tensor<256x128xi1>, tensor<256x128xf32>
    return %0 : tensor<256x128xf32>
  }
  ...
  func.func private @aten.lt.782(%arg0: tensor<128xi64>, %arg1: tensor<i64>) -> tensor<128xi1> {
    ...
    %1 = mhlo.compare  LT, %arg0, %0 : (tensor<128xi64>, tensor<128xi64>) -> tensor<128xi1>
  ...
  func.func private @aten.where.788(%arg0: tensor<128xi1>, %arg1: tensor<128xi64>, %arg2: tensor<128xi64>) -> tensor<128xi64> {
    %0 = mhlo.select %arg0, %arg1, %arg2 : tensor<128xi1>, tensor<128xi64>
    return %0 : tensor<128xi64>
  }
  ...
  func.func private @aten.ne.745(%arg0: tensor<128xi64>, %arg1: tensor<f64>) -> tensor<128xi1> {
    ...
    %2 = mhlo.compare  NE, %0, %1 : (tensor<128xf64>, tensor<128xf64>) -> tensor<128xi1>
  ...
  func.func private @aten.sum.730(%arg0: tensor<2x128x128xf32>) -> tensor<1x128x128xf32> {
    ...
    %1 = mhlo.constant dense<0.000000e+00> : tensor<f32>
    %2 = mhlo.reduce(%arg0 init: %1) across dimensions = [0] : (tensor<2x128x128xf32>, tensor<f32>) -> tensor<128x128xf32>
     reducer(%arg1: tensor<f32>, %arg2: tensor<f32>)  {
  ...
  func.func private @aten.where.762(%arg0: tensor<128x128xi1>, %arg1: tensor<128x128xf32>, %arg2: tensor<128x128xf32>) -> tensor<128x128xf32> {
    %0 = mhlo.select %arg0, %arg1, %arg2 : tensor<128x128xi1>, tensor<128x128xf32>
    return %0 : tensor<128x128xf32>
  }
  ...
  func.func private @aten.sum.827(%arg0: tensor<2x128x30522xf32>) -> tensor<1x1x30522xf32> {
    ...
    %1 = mhlo.constant dense<0.000000e+00> : tensor<f32>
    %2 = mhlo.reduce(%arg0 init: %1) across dimensions = [0, 1] : (tensor<2x128x30522xf32>, tensor<f32>) -> tensor<30522xf32>
     reducer(%arg1: tensor<f32>, %arg2: tensor<f32>)  {
      %4 = mhlo.add %arg1, %arg2 : tensor<f32>
      mhlo.return %4 : tensor<f32>
    }
