...
module attributes {gpu.container_module, torch.debug_module_name = "GraphModule"} {
  ...
  func.func @forward(%arg0: memref<2x10xf32, "cuda">) -> memref<2x10xf32, "cuda"> attributes {__placeholder__byre.entry_point} {
    ...
    %6 = call @Unknown0(%4, %alloc) : (memref<20xf32, "cuda">, memref<2x20xf32, "cuda">) -> memref<2x20xf32, "cuda">
    %alloc_0 = memref.alloc() : memref<2x20xf32, "cuda">
    byre.compute @MatmulOp_f32f32_f32(%6, %3, %alloc_0) {device = "cuda", lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 1 : i64} : memref<2x20xf32, "cuda">, memref<20x20xf32, "cuda">, memref<2x20xf32, "cuda">
    %7 = call @Unknown0(%2, %alloc_0) : (memref<20xf32, "cuda">, memref<2x20xf32, "cuda">) -> memref<2x20xf32, "cuda">
    %alloc_1 = memref.alloc() : memref<2x10xf32, "cuda">
    byre.compute @MatmulOp_f32f32_f32(%7, %1, %alloc_1) {device = "cuda", lhs_contracting_dimension = 1 : i64, memory_effects = [1 : i32, 1 : i32, 2 : i32], rhs_contracting_dimension = 1 : i64} : memref<2x20xf32, "cuda">, memref<10x20xf32, "cuda">, memref<2x10xf32, "cuda">
    %8 = call @Unknown2(%0, %alloc_1) : (memref<10xf32, "cuda">, memref<2x10xf32, "cuda">) -> memref<2x10xf32, "cuda">
  ...
  memref.global "private" constant @__constant_20xf32_cuda : memref<20xf32, "cuda"> = dense<[0.124238588, -0.0375917405, -0.178324029, 2.1018261E-4, -0.0708629936, 0.179958493, 0.201986402, -0.0302014686, -0.0842267424, 0.0796111747, 0.0201944318, -0.183529228, -0.133614406, -0.0192934573, 0.193412527, 0.219010666, -0.0464102961, 0.00334274326, -0.0029087835, 0.0903228372]>
