...
func.func @test_transpose_dynamic(%arg : tensor<3x4x5xi32>) -> () {
  ...
  %1 = "mhlo.dynamic_reshape"(%arg, %new_shape) : (tensor<3x4x5xi32>, tensor<3xi32>)  -> (tensor<?x?x?xi32>)
...
// CHECK: for operation : %c3_i32 = arith.constant 3 : i32, inferred values are:
// CHECK: 	3 : i32
// CHECK: for operation : %c4_i32 = arith.constant 4 : i32, inferred values are:
// CHECK: 	4 : i32
// CHECK: for operation : %c5_i32 = arith.constant 5 : i32, inferred values are:
// CHECK: 	5 : i32
// CHECK: for operation : %c0 = arith.constant 0 : index, inferred values are:
// CHECK: 	0 : index
// CHECK: for operation : %from_elements = tensor.from_elements %c4_i32, %c5_i32, %c3_i32 : tensor<3xi32>, inferred values are:
// CHECK: 	dense<[4, 5, 3]> : tensor<3xi32>
// CHECK: for operation : %0 = mhlo.dynamic_reshape %arg0, %from_elements : (tensor<3x4x5xi32>, tensor<3xi32>) -> tensor<?x?x?xi32>, inferred shapes are:
// CHECK: 	tensor<4x5x3xi32>
// CHECK: for operation : %0 = mhlo.dynamic_reshape %arg0, %from_elements : (tensor<3x4x5xi32>, tensor<3xi32>) -> tensor<?x?x?xi32>, inferred values are:
// CHECK: 	<UNKNOWN>
...
func.func @test_dynamic_callgraph(%arg : tensor<3x4x5xi32>) -> () {
  ...
  %c2 = arith.constant 5 : i32
  %new_shape = tensor.from_elements %c1, %c2, %c0 : tensor<3xi32>
  %0 = "mhlo.dynamic_reshape"(%arg, %new_shape) : (tensor<3x4x5xi32>, tensor<3xi32>)  -> (tensor<?x?x?xi32>)
...
func.func @test_dynamic_with_cf(%arg0: tensor<3x4x5xi32>, %arg1: i1) {
  %c0_i32 = arith.constant 3 : i32
  %c1_i32 = arith.constant 4 : i32
  %c2_i32 = arith.constant 5 : i32
  %from_elements = tensor.from_elements %c1_i32, %c2_i32, %c0_i32 : tensor<3xi32>
  %0 = "mhlo.dynamic_reshape"(%arg0, %from_elements) : (tensor<3x4x5xi32>, tensor<3xi32>) -> tensor<?x?x?xi32>
