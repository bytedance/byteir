...
module {
  ...
  func.func @main(%arg0: tensor<512x200xf32>, %arg1: tensor<512x2x100xf32>) -> tensor<128x2x100xf32> attributes {__placeholder__byre.entry_point} {
    ...
    %expanded = tensor.expand_shape %extracted_slice [[0], [1, 2]] : tensor<128x200xf32> into tensor<128x2x100xf32>
    %expanded_1 = tensor.expand_shape %extracted_slice_0 [[0], [1, 2]] : tensor<128x200xf32> into tensor<128x2x100xf32>
