...
module {
  ...
  func.func private @Unknown6(%arg0: memref<1x100x27x48x3xf32>) -> memref<51200xi32> attributes {__byteir_hlo_aggressive_fusion__} {
    ...
    %0 = memref.get_global @__constant_100x1296xi32 : memref<100x1296xi32>
    ...
    scf.for %arg1 = %c0 to %c388800 step %c1 {
      %2 = memref.load %collapse_shape[%arg1] : memref<388800xf32>
      %3 = arith.fptosi %2 : f32 to i32
      memref.store %3, %collapse_shape_0[%arg1] : memref<388800xi32>
    }
    ...
    scf.for %arg1 = %c0 to %c129600 step %c1 {
      %2 = arith.remsi %arg1, %c1296 : index
      %3 = arith.divsi %arg1, %c1296 : index
      ...
      %7 = memref.load %1[%3] : memref<100xi32>
    ...
    scf.for %arg1 = %c0 to %c51200 step %c1 {
      memref.store %c0_i32, %alloc_5[%arg1] : memref<51200xi32>
    }
    scf.for %arg1 = %c0 to %c129600 step %c1 {
      %2 = arith.remsi %arg1, %c1296 : index
      %3 = arith.divsi %arg1, %c1296 : index
      ...
      %6 = memref.load %alloc_5[%5] : memref<51200xi32>
      %7 = memref.load %0[%3, %2] : memref<100x1296xi32>
      %8 = arith.addi %6, %7 : i32
      memref.store %8, %alloc_5[%5] : memref<51200xi32>
    }
