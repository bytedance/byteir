// RUN: byteir-opt %s --host-opt="file-name=host_kernels.bc" --byre-opt | FileCheck %s
...
module {
  ...
  func.func private @Unknown0(%arg0: memref<1xi64>, %arg1: memref<1xi64>, %arg2: memref<1xi64>, %arg3: memref<1x128xi32>) -> (memref<1x128xi32>, memref<1x128xi32>) attributes {__byteir_hlo_aggressive_fusion__} {
