...
module attributes {byre.container_module, llvm.data_layout = ""} {
  ...
  ^bb2:  // pred: ^bb1
    ...
    %128 = llvm.add %20, %6  : i64
    %129 = llvm.mul %7, %2  : i64
