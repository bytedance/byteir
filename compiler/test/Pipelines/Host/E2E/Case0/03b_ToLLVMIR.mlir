...
module attributes {byre.container_module, llvm.data_layout = ""} {
  ...
  ^bb2:  // pred: ^bb1
    %7 = llvm.mul %1, %0  : i64
    %8 = llvm.add %7, %5  : i64
    %9 = llvm.getelementptr %4[%8] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    ...
    %21 = llvm.getelementptr %arg23[%20] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    llvm.store %18, %21 : !llvm.ptr<i32>
    %22 = llvm.add %5, %2  : i64
    llvm.br ^bb1(%22 : i64)
  ^bb3:  // pred: ^bb1
    llvm.br ^bb4(%1 : i64)
  ...
  ^bb5:  // pred: ^bb4
    %25 = llvm.getelementptr %arg23[%23] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    %26 = llvm.load %25 : !llvm.ptr<i32>
    %27 = llvm.getelementptr %arg16[%23] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    %28 = llvm.load %27 : !llvm.ptr<i32>
    %29 = llvm.mul %26, %28  : i32
    %30 = llvm.getelementptr %arg30[%23] : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
