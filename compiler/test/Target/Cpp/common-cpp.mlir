...
func.func @apply(%arg0: i32) -> !emitc.ptr<!emitc.opaque<"int32_t">> {
  // CHECK: int32_t* [[V2]] = &[[V1]];
  %0 = emitc.apply "&"(%arg0) : (i32) -> !emitc.ptr<!emitc.opaque<"int32_t">>
  // CHECK: int32_t [[V3]] = *[[V2]];
  %1 = emitc.apply "*"(%0) : (!emitc.ptr<!emitc.opaque<"int32_t">>) -> (i32)
  return %0 : !emitc.ptr<!emitc.opaque<"int32_t">>
}
