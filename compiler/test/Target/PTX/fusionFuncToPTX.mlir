...
module attributes {gpu.container_module}  {
  ...
  gpu.module @fusion_broadcast_kernel {
    ...
    llvm.func @fusion_broadcast_kernel(%arg0: !llvm.ptr<f32>, %arg1: !llvm.ptr<f32>, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: i64, %arg7: i64, %arg8: i64, %arg9: i64, %arg10: i64, %arg11: !llvm.ptr<f32>, %arg12: !llvm.ptr<f32>, %arg13: i64, %arg14: i64, %arg15: i64, %arg16: i64, %arg17: i64, %arg18: i64, %arg19: i64, %arg20: !llvm.ptr<f32>, %arg21: !llvm.ptr<f32>, %arg22: i64, %arg23: i64, %arg24: i64, %arg25: i64, %arg26: i64, %arg27: i64, %arg28: i64, %arg29: i64, %arg30: i64) attributes {gpu.kernel, nvvm.kernel} {
      ...
      %13 = llvm.insertvalue %arg11, %12[0] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %14 = llvm.insertvalue %arg12, %13[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %15 = llvm.insertvalue %arg13, %14[2] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %16 = llvm.insertvalue %arg14, %15[3, 0] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %17 = llvm.insertvalue %arg17, %16[4, 0] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %18 = llvm.insertvalue %arg15, %17[3, 1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %19 = llvm.insertvalue %arg18, %18[4, 1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %20 = llvm.insertvalue %arg16, %19[3, 2] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %21 = llvm.insertvalue %arg19, %20[4, 2] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %22 = llvm.insertvalue %arg20, %0[0] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %23 = llvm.insertvalue %arg21, %22[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %24 = llvm.insertvalue %arg22, %23[2] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %25 = llvm.insertvalue %arg23, %24[3, 0] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %26 = llvm.insertvalue %arg27, %25[4, 0] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %27 = llvm.insertvalue %arg24, %26[3, 1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %28 = llvm.insertvalue %arg28, %27[4, 1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %29 = llvm.insertvalue %arg25, %28[3, 2] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %30 = llvm.insertvalue %arg29, %29[4, 2] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %31 = llvm.insertvalue %arg26, %30[3, 3] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %32 = llvm.insertvalue %arg30, %31[4, 3] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
    ...
    ^bb5:  // pred: ^bb4
      %44 = llvm.extractvalue %11[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      ...
      %53 = llvm.getelementptr %44[%52] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
      %54 = llvm.load %53 : !llvm.ptr<f32>
      %55 = llvm.extractvalue %21[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<3 x i64>, array<3 x i64>)>
      %56 = llvm.mlir.constant(1152 : index) : i64
      %57 = llvm.mul %37, %56  : i64
      %58 = llvm.mul %39, %34  : i64
      %59 = llvm.add %57, %58  : i64
      %60 = llvm.add %59, %40  : i64
      %61 = llvm.getelementptr %55[%60] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
      %62 = llvm.load %61 : !llvm.ptr<f32>
      %63 = llvm.fsub %54, %62  : f32
      %64 = llvm.call @__nv_expf(%63) : (f32) -> f32
      %65 = llvm.extractvalue %32[1] : !llvm.struct<(ptr<f32>, ptr<f32>, i64, array<4 x i64>, array<4 x i64>)>
      %66 = llvm.getelementptr %65[%52] : (!llvm.ptr<f32>, i64) -> !llvm.ptr<f32>
      llvm.store %64, %66 : !llvm.ptr<f32>
