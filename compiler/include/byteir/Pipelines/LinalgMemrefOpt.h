...
#ifndef BYTEIR_PIPELINES_LINALGMEMREFOPT_H
#define BYTEIR_PIPELINES_LINALGMEMREFOPT_H
...
inline void registerLinalgMemrefOptPipeline() {
  PassPipelineRegistration<LinalgMemrefOptPipelineOptions>(
      "linalg-memref-opt", "Linalg Opt Pipeline in Memref",
      createLinalgMemrefOptPipeline);
}

} // namespace mlir

#endif // BYTEIR_PIPELINES_LINALGMEMREFOPT_H