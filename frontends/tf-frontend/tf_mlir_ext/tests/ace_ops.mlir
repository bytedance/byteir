...
func.func @test_custom_call_unregistered_type_string(%arg0 : tensor<!tf_type.string>) -> tensor<1x!tf_type.string> {
  %0 = "ace.custom_call"(%arg0) {call_target_name = "tf.Reshape"} : (tensor<!tf_type.string>) -> tensor<1x!tf_type.string>
  func.return %0 : tensor<1x!tf_type.string>
}
// CHECK: ace.custom_call

func.func @test_custom_call_unregistered_type_resource() -> tensor<!tf_type.resource> {
  %0 = "ace.custom_call"() {call_target_name = "tf.HashTableV2", byteir_attrs = {key_dtype = !tf_type.string, shared_name = "hash_table_50d7f8d1-3a3b-4948-9083-4100531b7dc9"}} : () -> tensor<!tf_type.resource>
  func.return %0 : tensor<!tf_type.resource>
}
// CHECK: ace.custom_call
...
func.func @test_custom_call_ace_type_string(%arg0 : tensor<!ace.string>) -> tensor<1x!ace.string> {
  ...
  func.return %0 : tensor<1x!ace.string>
}
// CHECK: ace.custom_call
...
func.func @test_custom_call_ace_type_resource() -> tensor<!ace.resource> {
  ...
  func.return %0 : tensor<!ace.resource>
}
// CHECK: ace.custom_call
...
func.func @test_ace_constant_case0() -> tensor<!ace.string> {
  ...
  func.return %0 : tensor<!ace.string>
}
// CHECK: ace.constant
