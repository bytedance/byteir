...
config.test_exec_root = os.path.join(config.onnx_frontend_obj_root, 'test')
...
tool_dirs = [
    config.onnx_frontend_tools_dir, config.mlir_tools_dir, config.llvm_tools_dir
]
